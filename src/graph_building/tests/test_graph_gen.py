...
@pytest.mark.parametrize('delta, expected_peaks', [
    (2, {
        ...
        '1.0': {
            '2020-01-05': {'value': 14, 'color': 'yellow'},
            '2020-01-08': {'value': 15, 'color': 'yellow'}
        },
        '0.0': {}
    }),
    (3, {
...
@pytest.mark.parametrize('beta, expected_edges, expected_graph_data', [
    (2, {
        ...
        ('2.0', '1.0'): [
            (('2020-01-04', '2020-01-05'), 0.0),
        ],
        ('1.0', '0.0'): []
    }, [
        (('3.0', '2020-01-03'), ('2.0', '2020-01-04'), {'slope': -1.0}),
        (('2.0', '2020-01-04'), ('1.0', '2020-01-05'), {'slope': 0.0})
    ]),
    (5, {
        ('5.0', '4.0'): [],
        ('4.0', '3.0'): [
        ...
        (('3.0', '2020-01-03'), ('2.0', '2020-01-04'), {'slope': -1.0}),
        (('2.0', '2020-01-04'), ('1.0', '2020-01-05'), {'slope': 0.0}),
        (('2.0', '2020-01-04'), ('1.0', '2020-01-08'), {'slope': -1.0}),
    ])
])
